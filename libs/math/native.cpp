...
Value math_add(std::vector<Value> arguments) {
    ...
    return Value(add(arguments[0].as.number, arguments[1].as.number));
}
...
Value math_subtract(std::vector<Value> arguments) {
    ...
    return Value(subtract(arguments[0].as.number, arguments[1].as.number));
}
...
Value math_multiply(std::vector<Value> arguments) {
    ...
    return Value(multiply(arguments[0].as.number, arguments[1].as.number));
}
...
Value math_divide(std::vector<Value> arguments) {
    ...
    return Value(divide(arguments[0].as.number, arguments[1].as.number));
}
...
Value math_pow(std::vector<Value> arguments) {
    ...
    return Value(power(arguments[0].as.number, arguments[1].as.number));
}
...
Value math_sqrt(std::vector<Value> arguments) {
    ...
    return Value(squareroot(arguments[0].as.number));
}
...
Value math_abs(std::vector<Value> arguments) {
    ...
    return Value(absolute(arguments[0].as.number));
}
