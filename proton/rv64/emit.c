...
static char *rname[] = {
	0,                                                /* [0] RXX */
	"t0", "t1", "t2", "t3", "t4", "t5",              /* [1-6] T0-T5 */
	"a0", "a1", "a2", "a3", "a4", "a5", "a6", "a7",  /* [7-14] A0-A7 */
	"s1", "s2", "s3", "s4", "s5", "s6", "s7","s8",   /* [15-22] S1-S8 */
	"s9", "s10", "s11",                               /* [23-25] S9-S11 */
	"fp",                                             /* [26] FP */
	"sp",                                             /* [27] SP */
	"gp",                                             /* [28] GP */
	"tp",                                             /* [29] TP */
	"ra",                                             /* [30] RA */
	"ft0", "ft1", "ft2", "ft3", "ft4",               /* [31-35] FT0-FT4 */
	"ft5", "ft6", "ft7", "ft8", "ft9", "ft10",       /* [36-41] FT5-FT10 */
	"fa0", "fa1", "fa2", "fa3", "fa4", "fa5",        /* [42-47] FA0-FA5 */
	"fa6", "fa7",                                     /* [48-49] FA6-FA7 */
	"fs0", "fs1", "fs2", "fs3", "fs4", "fs5",        /* [50-55] FS0-FS5 */
	"fs6", "fs7", "fs8", "fs9", "fs10", "fs11",      /* [56-61] FS6-FS11 */
	"t6",                                             /* [62] T6 */
	"ft11",                                           /* [63] FT11 */
};
