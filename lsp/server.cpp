  ...
  std::vector<ModuleFuncs> allModules = {
      ...
      {"collections",
       {{"set_new", "Create new set"},
        ...
        {"set_has", "Check if set has element"},
        {"set_remove", "Remove element from set"},
        {"set_size", "Get set size"},
        ...
        {"stack_push", "Push element to stack"},
        {"stack_pop", "Pop element from stack"},
        {"stack_peek", "Peek at top of stack"},
        ...
        {"queue_front", "Get front element of queue"},
      ...
      {"log",
       {{"debug", "Log debug message"},
        ...
        {"set_level", "Set log level (0=DEBUG,1=INFO,2=WARN,3=ERROR)"},
        {"get_level", "Get current log level"},
        {"set_file", "Set log file path"},
        {"set_color", "Enable/disable colored output"},
        {"set_timestamp", "Enable/disable timestamps"}}},
      {"strings",
       {{"split", "Split string into array"},
        {"join", "Join array elements into string"},
        {"trim", "Remove whitespace from both ends"},
        {"trim_left", "Remove whitespace from left"},
        {"trim_right", "Remove whitespace from right"},
        ...
        {"index_of", "Find first occurrence index"},
        {"last_index_of", "Find last occurrence index"},
        ...
        {"equals", "Check if strings are equal"},
        {"equals_ignore_case", "Check if strings are equal (case-insensitive)"},
        {"to_title_case", "Convert to title case"},
        {"swap_case", "Swap character cases"},
        {"is_upper", "Check if all cased characters are uppercase"},
        {"is_lower", "Check if all cased characters are lowercase"},
        ...
        {"encode", "Encode string (base64, hex, url)"},
        {"decode", "Decode string (base64, hex, url)"},
        {"hash", "Hash string (md5, sha1, sha256)"},
        {"escape_regex", "Escape special regex characters"},
        {"from_code_point", "Create string from Unicode code point"},
        {"code_point_at", "Get Unicode code point at index"}}}};
